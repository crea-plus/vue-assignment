<template>
  <Suspense>
    ...
    <p v-if="store.loading" class="text-lg text-gray-700">
      Loading...
    </p>
    <p v-else-if="store.error" class="text-lg text-red-500">
      {{ store.error }}
    </p>
    ...
    <section
      v-else ref="list" class="flex flex-col gap-5 overflow-y-scroll overflow-x-auto" :style="{
